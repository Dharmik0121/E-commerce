...
export default function Checkout() {
  ...
  const publishableKey =
    "pk_test_51NJX1eSGAOSCF5JCc4K0BS2aRYOhv63q0XTbbSTQGklsT1obHgRqYJrdnuxl9dgAGxFmsPVPv7WVqrGNNiZzHoJl00AJfieKyM";
  ...
  if (orderSuccess) {
    return (
      <section className="h-screen text-black bg-gray-200">
  ...
  return (
    <div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
            ...
            {cartItems && cartItems.length ? (
              cartItems.map((item) => (
                ...
                >
                  ...
                  />
                  <div className="flex text-black w-full flex-col px-4 py-4">
        ...
        <div className="mt-10 text-black bg-gray-50 px-4 pt-8 lg:mt-0">
